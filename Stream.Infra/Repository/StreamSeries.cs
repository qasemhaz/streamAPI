...
{
    public class StreamSeries : IStreamSeries
    {
        public readonly IDbContext dbContext;
        public StreamSeries(IDbContext dbContext)
        {
        ...
        public void Create(Streamseries stream)
        {
            ...
            var result = dbContext.Connection.Execute("STREAMSERIES_package.inserts", p, commandType: CommandType.StoredProcedure);
        }
        ...
        public void Delete(int id)
        {
            ...
            var result = dbContext.Connection.Execute("STREAMSERIES_package.Deletebyid", p, commandType: CommandType.StoredProcedure);
        }

        public List<Streamseries> GetAll()
        {

            IEnumerable<Streamseries> result = dbContext.Connection.Query<Streamseries>("STREAMSERIES_package.Getall", commandType: CommandType.StoredProcedure);
        ...
        public Streamseries GetById(int id)
        {
            ...
            IEnumerable<Streamseries> result = dbContext.Connection.Query<Streamseries>("STREAMSERIES_package.Getbyid", p, commandType: CommandType.StoredProcedure);
        ...
        public void Update(Streamseries stream)
        {
            ...
            var result = dbContext.Connection.Execute("STREAMSERIES_package.updates", p, commandType: CommandType.StoredProcedure);
        }
    }
}
